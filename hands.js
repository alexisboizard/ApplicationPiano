...
// width = getWebcamResolution().then(function(result){
//   return result.width;
// });
// height = getWebcamResolution().then(function(result){
//   return result.height;
// });

// alert("Width : " + width + " Height : " + height);

console.log(canvasCtx3.width, canvasCtx3.height); // 0 0                                        
